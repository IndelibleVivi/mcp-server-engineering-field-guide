...
- 加入完整 bilingual architecture atlas：renderer-neutral 26-node / 42-edge model、三组 native portrait view pairs、editable Excalidraw sources、publication SVGs 与可重复执行的 render pipeline。
