...
- Added a stable capability-boundary core covering evidence, HTTP resources, trust, state, effects, egress, deployment, documentation, and review.
- Added synchronized English and Simplified Chinese editions.
- Added pinned profiles for MCP `2025-06-18`, `2025-11-25`, and `2026-07-28`, plus JSON-RPC 2.0, HTTP RFC 9110/9112, and dated integration guidance.
- Added a public case study with review reconciliation, verification matrix, projected public receipts, and explicit residual boundaries.
